...
class VolumeSetMTPP(PPModel):
    ...
    def __init__(
        ...
        Args:
            decoder: Recurrent decoder (e.g., SS2P2SetDecoder)
    ...
    def get_total_intensity_and_items(self, h_t, volumes=None, state_features=None, potential_feats=None):
        ...
        if self.intensity_type == 'static':
            ...
            if getattr(self.decoder, 'intensity_activation', None) == 'softplus':
            ...
            elif getattr(self.decoder, 'intensity_activation', None) == 'softplus':
...
def create_volume_set_mtpp(
    ...
    # Create decoder
    decoder_type = config.get('decoder_type', 'ss2p2').lower()
