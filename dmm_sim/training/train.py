...
from dmm_sim.models.volume_set_mtpp import VolumeSetMTPP, create_volume_set_mtpp
from dmm_sim.training.data_loader import create_bfnx_dataloaders
...
def main():
    ...
    parser.add_argument('--decoder-type',
                        ...
                        default='ss2p2',
                        help='Decoder/backbone: SS2P2 (bounded rate x rate-neutral marks), '
                             'the plain S2P2 diagonal SSM it extends, or LGM '
                             '(linear Hawkes ground x rate-neutral marks)')
